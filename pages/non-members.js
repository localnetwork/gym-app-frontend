...
export default function NonMembers() {
    ...
    const { nonMembersTransactions, isNonMembersTransactionsLoading, refetchNonMembersTransactions } = useEntityState((state) => ({
                    ...
                    {isNonMembersTransactionsLoading ? (
                        ...
                        <div> 
                            ...
                            <div className="flex flex-col items-center justify-center">
                                ...
                                <h2 className="text-xl font-bold">No transactions found at the moment. Please try again later.</h2>
                            </div>  
                            )}
