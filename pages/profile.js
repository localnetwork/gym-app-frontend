                ...
                {profile && (
                    <>
                        ...
                        <div className="flex items-center justify-between mt-[-50px] z-[1] relative px-[50px]">
                            ...
                            <span
                                className=" avatar block w-[100px] h-[100px] rounded-full p-3 border-[7px] border-[#111214]"
                                style={{
                                background: avatarService.findColor(profile.avatarColor),
                                }}
                            >
                            ...
                            <h1 className={`text-[20px] pl-[15px]  ${montserrat.className} font-bold`}>{profile.name} </h1>
                            </div>
                            ...
                            <div className="pt-[70px]">
                                ...
                                className=" text-white py-3 px-5 flex items-center gap-x-[5px] min-w-[100px] text-center rounded-[5px] bg-[#4E5058]"
                                >
                    ...
                    <div className="bg-[#232528] rounded-[7px] p-[15px] border border-[#ccc] border-opacity-10">
                        <div className="select-none tab-links gap-x-[15px] flex items-center border-b border-[#ccc] border-opacity-10">
                            <div className={`${currentTab === "about" ? "border-b-[2px] border-[#ccc]" : ""} hover:border-b-[2px] border-[#ccc] cursor-pointer`} onClick={() => {
                                setCurrentTab("about");
                            }}>
                                About
                            </div>
                            <div className={`${currentTab === "orders" ? "border-b-[2px] border-[#ccc]" : ""} hover:border-b-[2px] border-[#ccc] cursor-pointer`} onClick={() => {
                                    ...
                                    <>
                                        ...
                                        {profile?.qr_code && (
                                            <div className="mb-3">
                                                ...
                                                <Link href={process.env.NEXT_PUBLIC_API_URL + profile?.qr_code} target="_blank" className="group inline-block relative">
                                                    <span className="group-hover:flex hidden bg-[#000] bg-opacity-80 text-white text-center justify-center items-center justify-center absolute p-5 h-full w-full z-[1]">View Image</span>
                                                    <Image className="bg-white" src={process.env.NEXT_PUBLIC_API_URL + profile?.qr_code} width={100} height={100} />
                                                </Link>
                                            </div>
                                        )}
                                    </>
