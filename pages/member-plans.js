...
export default function Promos() {
  ...
  const { publicPromos, isPublicPromosLoading, refetchPublicPromos } =
              ...
              <div>
                ...
                {publicPromos?.map((promo, index) => (
                  <div key={index} className="mb-4 bg-[#fff] p-[30px]">
                        ...
                        <div>
                          {promo.duration && (
                            <div className="flex gap-[5px]">
                              ...
                              {promo.membership_months > 0
                                ? `${helper.daysFormatter(
                                    promo.membership_months
                                  )}`
                                : "Lifetime"}
                            </div>
                          )}
                    ...
                    <div
                      className="inline-flex max-w-[220px] mt-[15px] px-[30px] items-center justify-center hover:bg-green-600 text-center cursor-pointer text-[15px] font-bold rounded-[6px] bg-green-500 py-[10px] text-black text-uppercase w-full"
                      onClick={() => {
                        setModalInfo({
                          id: "checkout-modal",
                          title: `Checkout`,
