    ...
    <div>
      <form onSubmit={onSubmit}>
        <div className="bg-white rounded-[15px] mt-[15px] mb-[30px] relative shadow-[0_4px_8px_0_rgba(0,0,0,0.1)] border border-[#e7e7e7] text-[#121212] rounded-[15px] pt-[50px] p-[30px]">
          <span className="rounded-full bg-[#280031] text-white absolute left-[15px] top-[-15px] border-[5px] border-[#fff] w-[40px] h-[40px] inline-block text-center text-[20px] font-bold bg-[#009CFF]">
            1
          </span>
            ...
            {paymentMethods.map((item, index) => (
              <div key={index} className="w-full md:max-w-[50%] p-[7px]">
                ...
                <label
                  ...
                  className={`${
                    payload.payment_method === item.id ? "!opacity-100" : ""
                  } block border-[2px] relative border-[#280031] min-h-[100px] pt-[5px] rounded-[15px] hover:opacity-70 w-full flex items-center justify-center cursor-pointer h-full`}
                >
                  {payload.payment_method === item.id && (
                    <span className="absolute top-[5px] left-[5px] text-[10px] bg-[#280031] text-white px-[15px] py-[5px] rounded-[5px]">
                      Selected
                    </span>
                  )}
                  <Image
              ...
              <div className="text-center">
                <div
                  dangerouslySetInnerHTML={{
                    __html: paymentMethods.find(
                      (item) => item.id === payload.payment_method
                    )?.instruction,
                  }}
                />
                ...
                <div className="w-full">
                  ...
                  >
                    <img
                      ...
                      className="max-w-[300px] max-h-[200px] h-auto mt-2 mb-2"
                    />
                  </a>
                </div>
              )}
              <div className="flex flex-wrap gap-[15px]">
                <div className="w-full">
                  ...
                  <input
                    ...
                    name="proof"
                    id="proof"
                    className="w-full border border-dashed text-center border-[2px] w-full border-[#e7e7e7] p-[10px] rounded-[5px]"
                  />
                </div>
              </div>
        ...
        <button
          type="submit"
          className={`bg-[#009CFF] text-black text-[20px] font-bold px-[30px] py-[10px] rounded-[6px] mt-[20px] inline-block ${
